> **17 Eylül 2026 güncellemesi:** Python ve R çalıştırıldı; kullanıcının SPSS sayısal kontrolünde 20/20 eşleşme görüldü. [Güncel kayıt](GUNCEL-DOGRULAMA.md). Aşağıdaki eski çalışma/yayın durumları tarihsel kayıttır.
